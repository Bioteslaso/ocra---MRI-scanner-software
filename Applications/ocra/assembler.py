...
class Assembler:
    ...
    def assemble(self, ass_inp_file):
        ...
        b = bytes()
        conv_hex_bytes = [struct.pack('<I', hex_int) for hex_int in hex_ints]
        b = b.join(conv_hex_bytes)

        # Logging
        self.logger.info("Hex bytes = {}\n".format(conv_hex_bytes))
        self.logger.info("Length of hex bytes = {}\n".format(len(conv_hex_bytes)))
        ...
        # Machine code file
        output_filename = ass_inp_file[0:-4] + '_hex.txt'
